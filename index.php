...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO student_grades (registration, subjectcode, total_marks) VALUES (?, ?, ?)";
    $stmt = $conn->prepare($sql);

    if (!$stmt) {
        $message = "Error: " . $conn->error;
    } else {
        $stmt->bind_param('ssi', $registration, $subjectcode, $total_marks);
...
<body>
    ...
    <script>
        function showSuccessMessage() {
            document.getElementById("grading-form").style.display = "none"; // Hide the form
            document.getElementById("success-message").style.display = "block"; // Display the success message
        }
    </script>
</head>
<body>
    <form method="POST" action="/submit" id="grading-form">
        <div class="registration-number">
            ...
            <label for="SUM">Total_Mark : </label>
            <input type="number" id="SUM" name="Total_Marks" size="4" min="0" max="150" style="width: 200px;" required>
    ...
    <div id="success-message" style="display: none;">
        ...
        <!-- You can add more content or redirect the user to another page here. -->
    </div>
    <div class="container">
        ...
        <input type="file" id="pdfInput" accept=".pdf" onchange="changeButtonLabel(this)">
